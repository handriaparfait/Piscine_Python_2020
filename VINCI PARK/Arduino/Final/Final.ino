...
void compartimentLoop(int pin, int echo, float sound, int distance, int portActive, int portInactive, int num_capt){
...
//  pinMode(ECHO_PIN1, INPUT); 
 ...
 compartimentInit(2,3,340,180,10,11);
 compartimentInit(4,5,340,180,12,13);
 compartimentInit(7,6,0,180,8,9);
}
...
compartimentLoop(2,3,0.34,240,10,11,1);
compartimentLoop(4,5,0.34,240,12,13,2);  
compartimentLoop(7,6,0.0,180,8,9,3);
